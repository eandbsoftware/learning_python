...
def width_test(N):
    ...
    # width gives a total minimum field width for the substituted text
...
if __name__ == '__main__':
    ...
    import sys
    # Tests to see if arguments are passed to decide whether to run canned self-test 
    # or command line specified test.
    if len(sys.argv) == 1:
        selftest()
    else:
